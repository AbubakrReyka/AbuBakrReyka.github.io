...
Проблема:`;
  ...
  const MODAL_CONTENT = {
    ...
    'trust-location': {
      title: 'Махачкала',
      body: `<p>Принимаем автомобили в <strong>Махачкале</strong>. Точный адрес мастерской присылаем после записи, чтобы удобно спланировать маршрут.</p>`,
      actions: () => [
    ...
    'price-mount': {
      ...
      body: `<p>Аккуратный демонтаж и монтаж рулевой рейки на автомобиле, включая проверку пыльников, тяг и наконечников. После установки рекомендуем сделать развал-схождение. Цена зависит от марки автомобиля и сложности доступа.</p>
